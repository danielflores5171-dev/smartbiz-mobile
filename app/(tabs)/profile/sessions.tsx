        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                La estructura de gestión de sesiones y sus acciones ya está
                preparada para integrarse con la web; falta autorización
                Bearer/cookies y endpoint real de sesiones activas.
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text
                style={{ color: colors.muted, marginTop: 6, lineHeight: 22 }}
              >
                El listado de sesiones, selección, cierre individual y cierre
                múltiple siguen operando como demo/local y se conectarán al
                backend real en futuras actualizaciones.
              </Text>
            </View>
          </View>
        </View>
